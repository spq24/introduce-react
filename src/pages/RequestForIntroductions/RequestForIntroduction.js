...
import { Avatar, Card, Grid, Button, Chip } from '@material-ui/core';
                  ...
                  <div className="d-flex justify-content-around">
                    {
                      !requestForIntroduction.closed ?
                        <a href={`/request-for-intro/${id}`} target="_blank" rel="noopener noreferrer">
                          <Button
                            size="large"
        ...
        <Grid item md={4} lg={12} xl={4}>
          <Card className="card-box card-box-hover">
            <div className="text-center py-3">
              ...
              <div className="divider mx-auto my-3" />
              <div className="text-center px-3">
                <a href={`https://www.linkedin.com/sharing/share-offsite/?url=https://canyouintro.me/request-for-intro/${id}`} target="_blank" rel="noopener noreferrer">
                  <Button
                    fullWidth
        ...
        <Grid item md={4} lg={12} xl={4}>
          <Card className="card-box card-box-hover">
            <div className="text-center py-3">
              ...
              <div className="divider mx-auto my-3" />
              <div className="text-center px-3">
              <a href={`https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=https%3A%2F%2Fcanyouintro.me%2Frequest-intro%2F${id}%2F&display=popup&ref=plugin&src=share_button`} target="_blank" rel="noopener noreferrer">
                  <Button
                    fullWidth
